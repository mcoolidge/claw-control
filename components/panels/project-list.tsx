        ...
        {PROJECTS.map((p) => (
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-[10px] text-zinc-600">{p.taskCount} tasks · {p.docCount} docs</span>
            </div>
          </button>
        ))}
      </div>
